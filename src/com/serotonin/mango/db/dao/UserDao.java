...
public class UserDao extends BaseDao {
    ...
    class UserRowMapper implements GenericRowMapper<User> {
        public User mapRow(ResultSet rs, int rowNum) throws SQLException {
            ...
            user.setPassword(password != null ? password : "default");
    ...
    ejt.update(
        USER_UPDATE,
        new Object[] {
            user.getUsername() == null ? "" : user.getUsername(),  // Handle null username
            user.getPassword() == null ? "" : user.getPassword(), // Handle null password
            user.getEmail() == null ? "" : user.getEmail(),       // Handle null email
            user.getPhone() == null ? "" : user.getPhone(),       // Handle null phone
            boolToChar(user.isAdmin()),
            boolToChar(user.isDisabled()),
            user.getHomeUrl() == null ? "" : user.getHomeUrl(),   // Handle null homeUrl
